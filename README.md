...
另外，仓库还包含一个使用原生 HTML、CSS 和 JavaScript 编写的贪吃蛇小游戏示例，可直接在浏览器中打开体验。
...
1. 打开 `snake/index.html` 文件（双击或拖拽到浏览器中即可）。
2. 使用方向键或 `WASD` 控制蛇移动，按空格可暂停/继续。
3. 通过页面上的控制面板可以调整移动速度或重新开始游戏。
